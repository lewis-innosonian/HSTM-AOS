...
import com.example.hstm_aos.databinding.DialogFinishCourseBinding
import com.example.hstm_aos.databinding.DialogHowToConnectBinding

class FinishCourseDialog : DialogFragment() {

    private lateinit var binding: DialogFinishCourseBinding
    ...
    companion object {
        ...
        fun newInstance(courseName: String): FinishCourseDialog {
            return FinishCourseDialog().apply {
    ...
    override fun onCreateView(
        ...
        binding = DialogFinishCourseBinding.inflate(inflater, container, false)

        val name = courseName ?: "course"

        binding.messageTextView.text =
            "You’ve successfully completed\nthe $name course.\nYou’ve finished all courses\nand can now logout or close this session."
